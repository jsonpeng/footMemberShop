                    ...
                    <div class="form-group col-md-4">
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <select class="form-control" name="fendian">
                          ...
                          <option value="{!! $shops->id !!}" id="{{$shopname=$shops->name}}"  @if(array_key_exists('fendian', $input) && $input['fendian']==$shops->id) selected="selected" @endif>{!! $shops->name !!}</option>
                            @endforeach
  ...
  <div class="" style="margin-top:20px;">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="{!! route('memberCount.month') !!}" >当月统计</a></li>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function search() {
            window.location.href = "/memberCount/month?"+$('#form_search').serialize();
        }
